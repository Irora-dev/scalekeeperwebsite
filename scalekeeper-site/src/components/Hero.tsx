...
export default function Hero() {
  return (
    <section className="relative min-h-screen pt-20 md:pt-24 pb-16 overflow-hidden">
      {/* Background gradient */}
      <div className="absolute inset-0 bg-gradient-to-b from-background-dark via-background-section/50 to-background-dark" />

      {/* Decorative elements */}
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-accent-lime/5 rounded-full blur-3xl" />
      <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-primary-green/10 rounded-full blur-3xl" />
      ...
      <div className="section-container relative z-10">
        <div className="grid lg:grid-cols-5 gap-12 lg:gap-8 items-center min-h-[calc(100vh-8rem)]">
          ...
          <div className="lg:col-span-3 space-y-8">
            {/* Social Proof Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-background-section/80 rounded-full border border-text-muted/20">
              <div className="flex text-warning-amber text-sm">
                {'★★★★★'}
              </div>
          ...
          <div className="lg:col-span-2 relative">
            <div className="relative animate-float">
              ...
              <div className="relative mx-auto w-64 md:w-72 lg:w-80">
                {/* Glow effect */}
                <div className="absolute inset-0 bg-accent-lime/20 rounded-[3rem] blur-2xl" />

                {/* Phone body */}
                <div className="relative bg-gray-900 rounded-[2.5rem] p-2 shadow-2xl border border-gray-800">
                  {/* Screen */}
                  <div className="bg-background-dark rounded-[2rem] overflow-hidden aspect-[9/19]">
                    {/* Status bar */}
                    <div className="flex justify-between items-center px-6 py-2 text-xs text-text-secondary">
                      <span>9:41</span>
                      <div className="flex gap-1">
                        <div className="w-4 h-2 bg-text-muted rounded-sm" />
                        <div className="w-6 h-3 bg-accent-lime rounded-sm" />
                      </div>
                    </div>
                    ...
                    <div className="px-4 py-2 space-y-3">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <div className="w-8 h-8 bg-accent-lime/20 rounded-full flex items-center justify-center">
                      ...
                      {[
                        ...
                        <div key={i} className="bg-background-section/80 rounded-xl p-3 border border-text-muted/10">
                          <div className="flex items-center gap-3">
                            <div className="w-12 h-12 bg-primary-green/30 rounded-full flex items-center justify-center text-xl">
                              🐍
                            </div>
                            <div className="flex-1">
                              <div className="flex justify-between items-start">
                                <div>
                                  ...
                                  <p className="text-text-muted text-xs">{animal.species}</p>
                                </div>
                      ...
                      <div className="bg-background-section/80 rounded-xl p-3 border border-text-muted/10">
                        <p className="text-xs text-text-muted mb-2">Weight Trend - Udon</p>
                        <div className="h-16 flex items-end gap-1">
                          {[40, 45, 42, 48, 52, 50, 55, 53, 58, 56].map((h, i) => (
                            <div key={i} className="flex-1 flex flex-col items-center gap-1">
                              ...
                              />
                              {[2, 5, 8].includes(i) && (
                                <span className="text-warning-amber text-[8px]">★</span>
                              )}
                            </div>
                          ))}
                        </div>
                ...
                {/* Notch */}
                <div className="absolute top-2 left-1/2 -translate-x-1/2 w-24 h-6 bg-gray-900 rounded-b-2xl" />
              </div>
            </div>
          </div>
        </div>
